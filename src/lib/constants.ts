...
export const HOUSES: Record<HouseName, HouseDetails> = {
  Gryffindor: {
    ...
    crestImage: 'https://placehold.co/150x150/7F0909/FFC500.png?text=',
  ...
  Slytherin: {
    ...
    crestImage: 'https://placehold.co/150x150/1A472A/AAAAAA.png?text=',
  ...
  Ravenclaw: {
    ...
    crestImage: 'https://placehold.co/150x150/0E1A40/946B2D.png?text=',
  ...
  Hufflepuff: {
    ...
    crestImage: 'https://placehold.co/150x150/FFDB00/333333.png?text=',
